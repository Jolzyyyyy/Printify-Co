    ...
    public function overview(array $filters): array
    {
        ...
        return [
            ...
            'kpis' => [
                ...
                ['label' => 'Pending Invitations', 'value' => $adminClients->whereNull('invitation_accepted_at')->whereNull('invite_cancelled_at')->whereNotNull('invite_token')->count(), 'icon' => 'mail-clock', 'tone' => 'orange', 'url' => route('developer.invitations.index', ['status' => 'pending'])],
