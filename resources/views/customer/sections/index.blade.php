    ...
    <div class="min-h-screen bg-[#f7f4ef]" style="font-family: 'Poppins', sans-serif;">
        <section class="relative overflow-hidden bg-[#1f1d1c]">
            <div class="absolute inset-0">
                <img src="{{ asset('images/Homesld1.jpg') }}" alt="" class="h-full w-full object-cover opacity-30">
                <div class="absolute inset-0 bg-gradient-to-r from-[#1f1d1c] via-[#1f1d1c]/90 to-[#1f1d1c]/55"></div>
            </div>
            ...
            <div class="relative mx-auto max-w-7xl px-4 py-10 sm:px-6 lg:px-8">
                ...
                <div class="mt-3 grid gap-6 lg:grid-cols-[1fr,auto] lg:items-end">
                    ...
                    <div class="flex flex-wrap gap-3">
                        <a href="{{ route('dashboard') }}" class="inline-flex items-center justify-center rounded-lg border border-white/20 bg-white/10 px-4 py-3 text-sm font-black uppercase text-white backdrop-blur transition hover:bg-white/18">
                            Dashboard
                        </a>
                        <a href="{{ route('profile.edit') }}" class="inline-flex items-center justify-center rounded-lg bg-[#ff8d2a] px-4 py-3 text-sm font-black uppercase text-white shadow-lg shadow-orange-950/25 transition hover:bg-[#ff6a00]">
                            Profile
                        </a>
                    </div>
                </div>
